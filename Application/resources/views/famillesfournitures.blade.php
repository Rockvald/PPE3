...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" />
    <head>
        ...
        <link rel="stylesheet" href="http://localhost/PPE3/Application/resources/css/famillesfournitures.css" />
    ...
    <body>
        ...
        <section id="corps">
            ...
            if ($creation) { ?>
                <p class="confirm"><img class="img_confirm" src="http://localhost/PPE3/Application/storage/app/public/confirm.png" alt="Icon de confirmation" /> La famille a bien été créé</p><br />
